    ...
    return (
        <div className="bg-[url('https://i.ibb.co/tmSDJ1d/Super-sell-min.jpg')] bg-cover bg-center bg-no-repeat ">
            <div className='py-28 px-3 md:px-8 lg:px-32'>
                ...
                <Link to='/' className="relative inline-flex items-center justify-center p-4 px-6 py-3 overflow-hidden font-medium text-indigo-600 transition duration-300 ease-out border-2 border-white rounded-md shadow-md group">
